...
class NNTrainer:
    ...
    def train(
        ...
        valid_df = valid_df.iloc[:120]
        valid_target_df = valid_target_df.iloc[:120]
        ...
        if self.debug:
            ...
            logging.debug("Debug Mode. Only train on first 10 batches.")
        ...
        for epoch in mb:
            ...
            if val_score > best_val_score:
                ...
                print(best_model["backbone.0.weight"])
                # print(best_epoch, best_valid_preds)
                # print(best_model.layer0.conv1.weight.data)
    ...
    def _train_epoch(self, model, train_loader, criterion, optimizer, mb):
        ...
        for i, (images, targets) in enumerate(progress_bar(train_loader, parent=mb)):
            ...
            preds = model(images, is_train=True)
